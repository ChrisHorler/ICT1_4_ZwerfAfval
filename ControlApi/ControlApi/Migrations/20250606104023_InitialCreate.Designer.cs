...
namespace ControlApi.Migrations
{
    ...
    [Migration("20250606104023_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlApi.Data.Entities.POICategory", b =>
                {
                    b.Property<int>("categoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("POICategory", (string)null);
                });
            ...
            modelBuilder.Entity("ControlApi.Data.Entities.TrashType", b =>
                {
                    b.Property<int>("trashTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("trashTypeId"));

                    b.Property<string>("name")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.HasKey("trashTypeId");

                    b.ToTable("TrashType", (string)null);
                });
            ...
            modelBuilder.Entity("ControlApi.Data.Entities.Detection", b =>
                {
                    b.HasOne("ControlApi.Data.Entities.TrashType", "trashType")
                        .WithMany("detections")
                        .HasForeignKey("trashTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("trashType");
                });
            ...
            modelBuilder.Entity("ControlApi.Data.Entities.POI", b =>
                {
                    b.HasOne("ControlApi.Data.Entities.POICategory", "category")
                        .WithMany("POIS")
